		...
		//	$subdata[] = 0;
			...
			$set_status ='<div class="buttonHolder">';
				...
				if(defined("USERACCESS_EDIT".$Menu_id) && constant("USERACCESS_EDIT".$Menu_id) == 1){
					$set_status .= '<a class="button tick tooltip-2"  href="'.base_url().folder_name.'/'.$edit_url.'" target="_blank" title="Edit"><i class="fa fa-pencil"></i></a><a class="button tick tooltip-2"  href="'.base_url().$gallery['url'].'?page=preview" target="_blank" title="Preview"><i class="fa fa-eye"></i></i></a>';
				}
				else
					$set_status .= '';

...
class Article_search_class extends breaking_news_model 
{
    ...
    default:
		...
		$Total_rows = $this->db->query('CALL get_related_content_datatable ("'.$content_where_condition.' ","","","","","","","'.$content_type.'")')->num_rows();
		...
		$article_manager =  $this->db->query('CALL get_related_content_datatable ("'.$content_where_condition.'ORDER BY '.$order_field.' '.$order.' LIMIT '.$article_start.', '.$article_length.'","'.$check_in.'","'.$check_out.'","'.$Search_value.'","'.$Search_by.'","'.$Section.'","'.$Status.'","'.$content_type.'")')->result_array();	
		
		$recordsFiltered =  $this->db->query('CALL get_related_content_datatable ("'.$content_where_condition.' ","'.$check_in.'","'.$check_out.'","'.$Search_value.'","'.$Search_by.'","'.$Section.'","'.$Status.'","'.$content_type.'")')->num_rows();

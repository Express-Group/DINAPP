...
class section_widget_articles extends CI_Controller
{
	...
	public function view_temparticles()
	{
		...
		$widget_instance_details= $this->section_widget_article_model->getWidgetInstance('', '','', '', $widget_instance_id, 'adminview');		
		if($widget_instance_details['WidgetSection_ID'] != '' && $widget_instance_details['WidgetSection_ID'] != "0")
		{
		$widget_section_details = $this->section_widget_article_model->get_section_by_id($widget_instance_details['WidgetSection_ID']);

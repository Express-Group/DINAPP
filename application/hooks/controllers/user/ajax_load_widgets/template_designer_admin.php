				...
				foreach($values->widgetcontainer as $ckey => $cvalues )
				{
					...
					foreach($cvalues->widget as $wkey => $wvalues)
					{
						...
						}else
						{
							...
							$templateString['view_templ'] .= '<div class="widget-container widget-container-' .  $wvalues['id'] . '  fill_widget_'.$wvalues['data-widgetinstanceid'].'" id="fill_widget_'.$wvalues['data-widgetinstanceid'].'" data-pageparam="'.$page_param.'" data-contentfrom="'.$content_from.'">';

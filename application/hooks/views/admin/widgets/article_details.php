...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
    ...
    <!--<p class="ArticlePublish margin-bottom-10">--> Last Updated: <span><?php echo $last_updated_date;?></span><?php  if($content_type_id=='1'){ ?>&nbsp;&nbsp;|&nbsp;&nbsp; <span class="FontSize" id="incfont" data-toggle="tooltip" title="Zoom In">அ+</span><span class="FontSize" id="resetMe" data-toggle="tooltip" title="Reset">அ&nbsp;</span><span class="FontSize" id="decfont" data-toggle="tooltip" title="Zoom Out">அ-</span> <span id="print_article">&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-print"></i></span><?php } ?></p>

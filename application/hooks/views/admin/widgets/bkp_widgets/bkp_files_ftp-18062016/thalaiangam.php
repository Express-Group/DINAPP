			...
			foreach ($widget_instance_contents as $key => $value) {
			   foreach ($widget_instance_contents1 as $key1 => $value1) {
				...
				if($manual_image_path!='')
				{
						...
						//echo'manual';
				}else if ($original_image_path!='' && file_exists(destination_base_path . imagelibrary_image_path .$original_image_path))
					{
					$imagedetails = getimagesize(destination_base_path . imagelibrary_image_path.$original_image_path);
					$imagewidth = $imagedetails[0];
					$imageheight = $imagedetails[1];	
					...
					//echo destination_base_path . imagelibrary_image_path .$manual_image_path;
					}
				
					if(!file_exists(destination_base_path . imagelibrary_image_path .$manual_image_path))
					{
						//echo $show_image;

	...
	//	echo '<pre>'; print_r($widget_instance_contents); die();
		...
		foreach($widget_contents as $get_content)
		{
			...
			if($original_image_path !='')
			{
				...
				{
					if (file_exists(destination_base_path  . $original_image_path) )
					{
						$image_size = getimagesize(image_url. $original_image_path);
						$image_width = $image_size[0];																	
						$show_image = image_url. $original_image_path;
					}
				}
				else
				{
					if (file_exists(destination_base_path . imagelibrary_image_path . $original_image_path) )
					{

  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
    <div class="ArticleComments">
      <?php 	
		...
		?>
      <h4 class="ArticleHead comment_head">கருத்துகள்<span id="comments_count"><?php echo $comments_count;?></span></h4>
      <div class="CommentForm"> <span class="UserIcon"><i class="fa fa-user"></i></span>
        <form action="<?php echo base_url(); ?>user/commonwidget/post_comment" method="post" name="comment_form" id="comment_form">
          <textarea placeholder="ஒரு கருத்து எழுத ..."  name="article_comment" id="article_comment" style="resize: vertical; overflow: auto;"></textarea>
          ...
          <div class="post">
            ...
            <input type="submit" value="அனுப்பு" class="submit_post" name="submit">
          </div>
        </form>
    ...
    <div id="show_comments">
      <?php echo $article_comments['view_comments'];?> </div>
  </div>
</div>
<?php } 
}

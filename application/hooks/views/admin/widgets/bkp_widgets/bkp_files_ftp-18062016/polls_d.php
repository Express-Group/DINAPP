		...
		$polls = $this->widget_model->get_widget_Polls()->row_array();
			if($polls) 
				...
				<div class="BeforePoll" id="BeforePoll<?php echo $widget_instance_id; ?>">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="col-lg-6 col-md-7 col-sm-6 col-xs-6 people-mind" id="option_table">
                        <form>
                          <ul class="form-vote">
...
$(document).ready(function()
{
	...
	{
		var vote_count = parseInt($('input:radio[name=radioOption<?php echo $widget_instance_id; ?>]:checked').attr('set_value'))+parseInt(1);

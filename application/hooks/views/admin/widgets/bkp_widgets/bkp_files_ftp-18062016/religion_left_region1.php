...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content)
	{
		...
		{
		$show_simple_tab .='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="old-stick"><img src="'.image_url.'images/FrontEnd/images/old-roll.png" /></div>
		</div>
		...
		<div class="old-stick1"><img src="'.image_url.'images/FrontEnd/images/old-roll.png" /></div>
		</div>';

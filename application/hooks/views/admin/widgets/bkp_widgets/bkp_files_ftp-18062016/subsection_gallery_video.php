...
//				  
//				  <div class="play-icon1"> <img src="'.image_url. imagelibrary_image_path.'video-png.png" title = "'.$imagetitle.'" alt = "'.$imagealt.'" /></div>
//                  
//				  
//				  <figcaption class="video-p">
//				  <a href="#">'.$display_title.'</a></figcaption>
//				  
//				  
//               </div>
//			    </div>';
				...
				$show_simple_tab.='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 sub-right-0">
                  <div class="sub-video">';
                   ...
                   $show_simple_tab.=' <a href="'.$live_article_url.'" class="article_click" ><figure><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'" " />';
                    if($content_type==3)
{

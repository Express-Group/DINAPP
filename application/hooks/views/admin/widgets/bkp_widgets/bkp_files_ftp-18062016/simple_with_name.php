...
$show_simple_tab .= '<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 cinema-link "><figure class="bg-left"></figure>';
...
$show_simple_tab.= '<figure class="bg-right"></figure></div>';
$show_simple_tab.= '<div class="col-lg-7 col-md-6 col-sm-6 col-xs-6 cine-head">';
...
foreach($widget_instancemainsection as $get_section)
{
	...
	if($content['RenderingMode'] == "manual")
	{
		...
		$widget_instance_contents = $this->widget_model->get_widgetInstancearticles_rendering($get_section['WidgetInstance_id'],$get_section['WidgetInstanceMainSection_id'],$view_mode); 						
	}
	else
	{

...
if($subsec_leadstory_remdering_mode == "manual")
{
	...
	if(count($get_widget_instance_contents)>0)
	{
		...
		$TotalCount = $this->widget_model->get_liveContents_by_sectionId_count_rows($max_article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $multiple_contentID, 3, $is_home);
	...
	else
	{
		...
		$TotalCount = $this->widget_model->get_liveContents_by_sectionId_count_rows($max_article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $leadstory_contentID, 3, $is_home);		
...
$load_more_url = $domain_name.'topic/?sid='.$content['page_param'].'&cid=3';

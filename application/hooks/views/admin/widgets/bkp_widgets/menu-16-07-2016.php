...
<li><a class="AllTopic" href="<?php echo base_url()."special-articles"; ?>">சிறப்புக் கட்டுரைகள்</a></li>
...
<li><a class="AllTopic" href="<?php echo base_url()."specials/impressions"; ?>">இந்த நாளில் அன்று</a></li>
...
<li><a class="AllTopic" href="<?php echo base_url()."videos"; ?>">வீடியோ</a></li>
...
<ul>
<li><a class="AllList" href="<?php echo base_url()."edition_trichy/nagapattinam"; ?>"><i class="fa fa-caret-right fa-lg"></i> நாகப்பட்டினம்</a></li>
<li> <a class="AllList" href="<?php echo base_url()."edition_trichy/thiruvarur"; ?>"><i class="fa fa-caret-right fa-lg"></i>  திருவாரூர்</a></li>
<li> <a class="AllList" href="<?php echo base_url()."edition_trichy/nagapattinam/karaikal"; ?>"><i class="fa fa-caret-right fa-lg"></i>   காரைக்கால்</a></li>
</ul>

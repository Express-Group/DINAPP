...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail ArticleDetailContent">
  <div id="content" class="content" itemprop="description">
    ...
    <?php } ?>
    <?php echo $article_body_text; ?> </div>
  <div id="duplicate_content" class="printable" style="display:none;"><?php echo $article_body_text;?></div>
  <?php 
	  if($content['content_from']=="live"){
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 features">
  ...
  <div class="text-center play-pause-icon"> <span id="auto-play" class="cursor-pointer"><i class="fa fa-play"></i> </span> </div>
  <?php } ?>

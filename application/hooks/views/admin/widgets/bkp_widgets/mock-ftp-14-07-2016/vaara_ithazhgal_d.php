...
{
	if (file_exists(destination_base_path . imagelibrary_image_path  . $original_image_path1) )
	{																
...
{ 
	...
	$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag
														   ...
														   $show_simple_tab .='<img src="'.$dummy_image1.'" data-src="'.$show_image1.'" title = "'.$imagetitle1.'" alt = "'.$imagealt1.'" />

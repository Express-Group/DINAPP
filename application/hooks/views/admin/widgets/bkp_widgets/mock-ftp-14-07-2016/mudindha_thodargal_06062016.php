...
<div class="row">
  ...
  <figure class="bg-left"></figure>
    <figure class="bg-center1">முடிந்த தொடர்கள்</figure>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <ul class="old-junction">
          <li>
            <figure> <img src="images/FrontEnd/images/dinamani_logo_150X150.jpg" />
              <figcaption>
                <h4>தரம்பால்</h4>
                <p>அழகிய மரம்</p>
              </figcaption>

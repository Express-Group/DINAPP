...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content)
	{
		...
		{
		$show_simple_tab .='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="old-stick old-stick-next"><img src="'.image_url.'images/FrontEnd/images/old-roll.png" /></div>
		</div>
		...
		<figcaption>'.$display_title.'</figcaption>
			...
			<div class="old-stick1 old-stick-next"><img src="'.image_url.'images/FrontEnd/images/old-roll.png" /></div>
			</div>';
			}

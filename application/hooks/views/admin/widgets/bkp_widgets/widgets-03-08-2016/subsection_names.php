...
if(@$page_section_id!="")
{
		...
		foreach($get_result as $section)
		{
			...
			?>
		<li <?php if($page_section_id==$section['Section_id']){ echo 'class="active"';}?>><a href="<?php echo $SubSectionPageURL?>"><i class="fa fa-circle" aria-hidden="true"></i><?php echo $name; ?></a></li>

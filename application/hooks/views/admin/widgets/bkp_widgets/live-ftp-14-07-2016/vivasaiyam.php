...
<article>
<figure><a  href="'.$live_article_url.'"   class="article_click" ><img src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></figure>
...
$show_simple_tab.= '</div>
<figure class="col-lg-6 col-md-6 col-sm-6 col-xs-12  move"><a  href="'.$live_article_url.'"   class="article_click" ><img src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></figure>
</div>';
...
<figure class="col-lg-6 col-md-6 col-sm-6 col-xs-12  move2"><a  href="'.$live_article_url.'"   class="article_click" ><img src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></figure>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  temple">

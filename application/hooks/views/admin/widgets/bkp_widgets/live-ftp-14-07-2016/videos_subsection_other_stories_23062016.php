...
$load_more_url = $domain_name.'topic/?sid='.$content['page_param'].'&cid=4';
...
if($subsec_leadstory_remdering_mode == "manual")
{
	...
	if(count($get_widget_instance_contents)>0)
	{
		...
		$TotalCount = $this->widget_model->get_liveContents_by_sectionId_count_rows($max_article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $multiple_contentID, 4, $is_home);
	...
	else
	{
		...
		$TotalCount = $this->widget_model->get_liveContents_by_sectionId_count_rows($max_article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $leadstory_contentID, 4, $is_home);
...
else
{
	$leadstory_contentID = '';
	$article_limit = ($this->input->get('per_page') != '') ? $this->input->get('per_page'):0;
	$widget_instance_contents = $this->widget_model->get_liveContents_by_sectionId($article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $leadstory_contentID, 4, $is_home);

...
if($subsec_leadstory_remdering_mode == "manual")
{
	...
	if(count($get_widget_instance_contents)>0)
	{
		...
		$widget_instance_contents = $this->widget_model->get_liveContents_by_sectionId($article_count, $page_section_id, $view_mode, $article_limit, $subsec_leadstory_remdering_mode, $multiple_contentID, 1, $is_home);
		 $TotalCount = $this->widget_model->get_liveContents_by_sectionId_count_rows($max_article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $multiple_contentID, 1, $is_home);
	...
	else
	{
		...
		$TotalCount = $this->widget_model->get_liveContents_by_sectionId_count_rows($max_article_count, $page_section_id, $view_mode, $subsec_leadstory_max_article, $subsec_leadstory_remdering_mode, $leadstory_contentID, 1, $is_home);

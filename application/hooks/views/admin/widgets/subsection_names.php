...
if(@$page_section_id!="")
{
		...
		foreach($get_result as $section)
		{
			...
			?>
		<li class ="<?php if($page_section_id==$section['Section_id']){ echo "active";}?> <?php if(($page_section_id!=$section['Section_id'] )&&($name == "முடிந்த தொடர்கள்")){ echo "mudintha_thodargal";}?>"><a href="<?php echo $SubSectionPageURL?>"><i class="fa fa-circle" aria-hidden="true"></i><?php echo $name; ?></a></li>

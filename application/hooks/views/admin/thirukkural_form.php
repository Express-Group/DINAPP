            ...
            <div class="kural-left">
              ...
              <div class="kural-left-content">
                <p>
                  ...
                  <span class="mandatory">*</span></p>
                <p class="kural-box">
                  <input id="kural_font" class="box-shad box-shad1" name="kural_font" type="number" min="9" max="12" value="<?php if(isset($fontsize)){ echo $fontsize;}else{echo set_value('kural_font');}?>" >
                </p>
              </div>
              <div class="kural-left-content">
                <div class="tab">

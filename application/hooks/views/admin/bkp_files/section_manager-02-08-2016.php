...
<div class="Container">
    <div class="BodyWhiteBG">
		...
		{ ?>
                <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>dmcpan/section_manager/class_add_section_form" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
                <?php }?>
                <p class="FloatRight SaveBackTop remoda1-bg"><a href="#" type="button" onclick="window.open('<?php echo base_url();?>dmcpan/section_manager/view_sitemap', '_blank');" class="btn-primary btn"><i class="fa fa-sitemap"></i>  Site Map</a></p>
...
function delete_section(section_id,name)
{
	...
	if(r)
	{
		window.location = "<?php echo base_url();?>dmcpan/section_manager/class_delete_section/"+section_id;
	}		
}
...
function section_datatables()
 {
    ...
    $('#example').dataTable( {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/section_manager/section_datatable",
			"type" : "POST",
			"data" : {
...
$("#flash_msg_id").slideDown(function() {
	...
	var flash_success = '<?php echo $this->session->flashdata('failure_delete'); ?>';
	show_toastr(flash_success, 2);
/*});*/
<?php } ?>

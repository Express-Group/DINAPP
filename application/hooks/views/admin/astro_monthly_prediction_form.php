...
{
	$title1 = 'Astrology Monthly predictions - Edit';
}else{ $title1 = 'Astrology Monthly predictions - Create';}
		...
		<form name="monthlyPredictions_form" id="monthlyPredictions_form" action="<?php echo base_url(); ?>dmcpan/astro_monthly_prediction/add_monthly_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<p class="FloatRight save-back save_margin article_save"> 
				 <a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/astro_monthly_prediction"><i class="fa fa-reply fa-2x"></i></a>

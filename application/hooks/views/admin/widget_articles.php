...
<div class="css_and_js_files">
  ...
  <link rel="stylesheet" href="<?php echo base_url().'css/admin/template_design/css/jquery-ui.css'; ?>">
...
var admin_folder = "<?php echo folder_name; ?>"; 
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>includes/ckeditor/adapters/jquery.js"></script> 
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery.dataTables.rowReordering.js"></script>
...
<script type="text/javascript" src="<?php echo base_url()."js/admin_view/template_design/js/widget-article-custom-image.js" ?>" ></script>
<script type="text/javascript">
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery.infinitescroll.min.js"></script>
<script type="text/javascript">
var jqis = $.noConflict();
$(document).ready(function() {
	...
	jqis(".set_image").click(function(){
	 ...
	 var $container = jqis('.popup_images');
		...
		$container.html('<div class="LoadingSelectImageLocal" style="display: block;"><img src="<?php echo base_url(); ?>images/admin/loadingimage.gif" style="border:none; width:23px; height:23px;text-align: center;float: none;margin: 0px;padding: 0px;"><br>Loading ...</div>');

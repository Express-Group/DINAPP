			...
			<table class="Ecenic_import_image">
					<colgroup><col width="auto"><col width="750px"></colgroup>
						...
						<tr>
							  ...
							  <td  >&nbsp  &nbsp &nbsp  &nbsp<a id="import_article" href="<?php echo base_url().'dmcpan/migration/get_articles' ?>"<i class="fa fa-download"></i></td>
						</tr>
						<tr>
			...
			<table class="Ecenic_import_image">
					<colgroup><col width="auto"><col width="750px"></colgroup>
						...
						<tr>
							  ...
							  <td  >&nbsp  &nbsp &nbsp  &nbsp<a id="import_article" href="<?php echo base_url().'dmcpan/migration/get_galleries' ?>"<i class="fa fa-download"></i></td>
						</tr>
						<tr>
			...
			<table class="Ecenic_import_image">
					<colgroup><col width="auto"><col width="750px"></colgroup>
						...
						<tr>
							  ...
							  <td  >&nbsp  &nbsp &nbsp  &nbsp<a id="import_article" href="<?php echo base_url().'dmcpan/migration/get_video' ?>"<i class="fa fa-download"></i></td>
						</tr>
						<tr>

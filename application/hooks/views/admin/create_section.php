...
<script type="text/javascript" src="<?php echo base_url(); ?>js/section_create.js"></script>
	...
	$(document).ready(function()
	{
		...
		$("#btnSaveTop").click(function() 
		{
			...
			if($("#frmSectionMaster").valid())
			{
				...
				url: "<?php echo base_url(); ?>dmcpan/section_manager/"+url_fun+"",
...
<div class="Container">
  <form name="frmSectionMaster" id="frmSectionMaster" method="post" action="<?php echo base_url()."dmcpan/section_manager/class_section_add";?>" enctype="multipart/form-data" >
    <div class="BodyWhiteBG">
      <div class="BodyHeadBg Overflow clear">
        ...
        <p class="FloatRight save-back save_margin"> <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/section_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
        ...
        <div class="section_form">
          ...
          <div class="section2">
            ...
            <p class="FloatRight save-back"> 
              <!--<a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/section_manager";?>" data-toggle="tooltip" title="Hooray!"><i class="fa fa-reply fa-2x"></i></a>
...
function get_parent_section()
{
	...
	$.ajax(
	{
		url: "<?php echo base_url(); ?>dmcpan/section_manager/get_parent_url_structure", 
		type: "post",
...
function get_author_details()
{
	...
	$.ajax(
	{
		url: "<?php echo base_url(); ?>dmcpan/section_manager/get_author_by_id", 
		type: "post",
...
function get_pagemaster_details()
{
	...
	$.ajax(
	{
		url: "<?php echo base_url(); ?>dmcpan/section_manager/getPageDetails", 
		type: "post",
...
function display_order()
{
	...
	$.ajax(
	{
		...
		url: "<?php echo base_url(); ?>dmcpan/section_manager/get_sectionname", 
		type: "post",
...
function get_display_order()
{
	...
	$.ajax(
	{
		url: "<?php echo base_url(); ?>dmcpan/section_manager/get_maxdisplay_order", 
		type: "post",
		data: {"chek_val":chek_val,"menu_id":menuid,"section_id":section_id,"order":ddorder,"section_id": section_id},
		dataType: "json",
		success: function(data)
...
function get_last_sectionname()
{
	...
	$.ajax(
	{
		url: "<?php echo base_url(); ?>dmcpan/section_manager/get_lastsectionname", 
		type: "post",
		data: {"chek_val":chek_val,"menu_id":menuid,"section_id":section_id,"order":ddorder,"section_id": section_id},
		//dataType: "json",
		success: function(data)
...
function check_records()
{
	$.ajax(
	{
		url: "<?php echo base_url(); ?>dmcpan/section_manager/check_records", 
		type: "post",
		data: {},
		dataType: "json",
		success: function(data)

...
$template_design_css 	= base_url()."css/admin/template_design/";
$template_design_js 	= base_url()."js/admin_view/template_design/";
$template_design_images	= base_url()."images/admin/template_design/";
?>
...
<div class="BodyHeadBg Overflow clear">
           ...
           <!--
            <button class="btn-primary btn FloatLeft right-wid" id="saveTemplate" style="display:none;" title="Save Template" ><i class="fa fa-file-text-o" data-original-title="Active"></i> Save Template</button>
            
            <a class="back-top FloatLeft" data-remodal-target="modal" href="#modal" id="preview"><i class="fa fa-desktop i_extra"></i></a>-->
            
            <!--<span style="float:right; display:none;" id="design_view_span">             
            <a href="#" target="_blank" class="static_design_link"><button class="btn btn-primary"  title="View Template Design"><i class="fa fa-eye" data-original-title="Active"></i>&nbsp;View Design </button></a> 
            
            <button class="btn-primary btn FloatLeft right-wid" id="publishTemplate"  title="Publish Template" style="display:none;"><i class="fa fa fa-flag" data-original-title="Active"></i> Publish </button>
            <button class="btn-primary btn FloatLeft right-wid" id="unpublishtop_id"  title="Unpublish Template" style="display:none;"><i class="fa fa fa-flag-o" data-original-title="Active"></i> Unpublish </button>
        ...
        <?php } ?>
            ...
            <span class="FloatRight save_margin article_save "> 
                <!--<button id="lock_templateDesign" name="lock_templateDesign" title="Unlock template" type="button" class="btn btn-primary FloatLeft i_button lock_template " data-lockStatus = '2' style="display:none;"><i style="" class="fa fa-lock change_lock"></i></button> -->
		...
		<div class="section group">
					<div class="col span_2_of_12  FrontPageLeft Tree">
						...
						<div id="tree">
							...
							{
								//print_r($attribs_array_details);
								////////  If we want Section page and article page $val = 2, Only Section page then below $val value should be Comment  //////
								//$val = 2;
								//$landing = '<li class="folder">IPL<ul><li class="folder">Fixtures <ul><li class="folder">Poll-A';
								$landing	= "";
								foreach($attribs_array_details as $attribs_array)
								{
									$attribs[@$attribs_array['pagetype']] = 'id="'.@$attribs_array['id'].'" data-sectionId="'.@$attribs_array['menuid'].'" data-pageType="'.@$attribs_array['pagetype'].'" data-pageId="'.@$attribs_array['id'].'"  data-pageCategory="'.@$attribs_array['menucategory'].'" data-url="load-section-template.php?tid='.@$attribs_array['id'].'" data-hasTemplate ="'.@$attribs_array['hasTemplate'].'" ';
								}
								//print_r($attribs_array_details); exit;
								//$attribs = "";
								switch($val)
								{
									case 1:
											...
											//$landing .= '<li '. @$attribs[1] .'>article'.':'.$val.'</li>';
											break;									
									case 2:
											//$landing .= '<li '. @$attribs[1] .'>section</li><li '. @$attribs[2] .'>article</li>';
											//$landing .= '<li '. @$attribs[2] .'>article</li>';
											$landing .= '<li '. @$attribs[2] .'>article</li>';
											break;
								}
							...
							if(count($section) > 0)
							{
								...
								{																								
								echo '<li class="" id="'.@$common_template_page['id'].'" data-sectionId="'.@$common_template_page['menuid'].'" data-pageType="1" data-pageId="'.@$common_template_page['id'].'"  data-pageCategory data-url="load-section-template.php?tid='.@$common_template_page['id'].'" data-hasTemplate ="'.@$common_template_page['hasTemplate'].'" >Common Templates</li>';
								
								$standard_article_page = @$section[count($section)-2]['page_det'][1]; /// only for article page
								echo '<li class="" id="'.@$standard_article_page['id'].'" data-sectionId="'.@$standard_article_page['menuid'].'" data-pageType="2" data-pageId="'.@$standard_article_page['id'].'"  data-pageCategory data-url="load-section-template.php?tid='.@$standard_article_page['id'].'" data-hasTemplate ="'.@$standard_article_page['hasTemplate'].'" >Common Article Page</li>';
								}
								...
								{																								
								echo '<li class="" id="'.@$clone_template_page['id'].'" data-sectionId="'.@$clone_template_page['menuid'].'" data-pageType="1" data-pageId="'.@$clone_template_page['id'].'"  data-pageCategory data-url="load-section-template.php?tid='.@$clone_template_page['id'].'" data-hasTemplate ="'.@$clone_template_page['hasTemplate'].'" >Clone widgets Templates</li>';								
								}
								...
								foreach($section as $section_value)
								{
								  if($last_inc < (count($section)-2))
								  {
									...
									//print_r($section_value['page_master_content'] ); exit;
									if($inc > 1)
									{
										$inc = 0;
									}
									//$page_attributes = @$section_value['page_det'];
									if(count($sub_menu)>0)
									{
										...
										//$landing = page_landing(2,@$section_value['page_det']);
										...
										{										
											...
											//print_r($submenu_value['page_det'][0]);
											$sub_attribs_array = "";
											$sub_attribs_array = @$submenu_value['page_det'][0];
											//print_r($attribs_array);
											$sub_attribs[@$sub_attribs_array['pagetype']] = 'id="'.@$sub_attribs_array['id'].'" data-sectionId="'.@$sub_attribs_array['menuid'].'" data-pageType="'.@$sub_attribs_array['pagetype'].'" data-pageId="'.@$sub_attribs_array['id'].'"  data-pageCategory="'.@$sub_attribs_array['menucategory'].'" data-url="load-section-template.php?tid='.@$sub_attribs_array['id'].'" data-hasTemplate ="'.@$sub_attribs_array['hasTemplate'].'" ';
											...
											echo '<li class="'.$have_child_sections.'" '. @$sub_attribs[1] .'>'. $submenu_value['Sectionname'];											
												...
												//$landing = page_landing(2,@$submenu_value['page_det']);
												echo "<ul>".$landing;	
												...
												if(isset($special_menu_details))
												{
													...
													{
														//echo $special_menu['Section_id']; exit;
														...
														//print_r($attribs_array);
														$special_menu_attribs[@$special_menu_attribs_array['pagetype']] = 'id="'.@$special_menu_attribs_array['id'].'" data-sectionId="'.@$special_menu_attribs_array['menuid'].'" data-pageType="'.@$special_menu_attribs_array['pagetype'].'" data-pageId="'.@$special_menu_attribs_array['id'].'"  data-pageCategory="'.@$special_menu_attribs_array['menucategory'].'" data-url="load-section-template.php?tid='.@$special_menu_attribs_array['id'].'" data-hasTemplate ="'.@$special_menu_attribs_array['hasTemplate'].'" ';
														...
														//$landing = page_landing(2,@$special_menu['page_det']);
														echo "<ul>".$landing."</ul>";	
													}
												}
												echo "</ul>";
					...
					<div class="col <?php echo $col_span_values; ?> FrontPageMiddle">
						<div class="iexp-example-section" >
                            ...
                            <span class="header_script_publish FloatRight" style="display:none;">
                                 ...
                                 <!--<a href="javascript:;" class="btn-primary btn FloatRight" onclick="return add_header_script()" id="addheader_script">Header Script</a>-->
                                     ...
                                     <!--<button name="addheader_script" id="addheader_script" title="Publish advertisements only" type="button" class="btn btn-primary save_changes_in_version"  style="display:none;">Header Script</button>--> 
							...
							<div id="fmLeftTabs" class="design-panel">
								...
								<div id="TemplateTypeHolder" class="left-panel-holders">	
									<div id="addTemplatesHolder" style="padding:4px;">
													...
													foreach($page_templates as $templates)
													{
														echo '<li>
																	<a class="button add-template-button" id="addColTemplate_'.$templates['templateid'].'">
																		<img class="add-template-img" data-templateId='.$templates['templateid'].'   src="'.base_url().$templates['template_imagepath'].'"/>
																	</a> 
															  </li>';	
														//$i++;	  
													}
                                        ...
                                        <!--<button class="btn-primary btn FloatLeft right-wid" id="clearTemplate" ><i class="fa fa-trash-o" data-original-title="Active"></i> Clear Template</button>-->
                                       <!-- <input type="button" id="clearTemplate" value="Clear Template" />
                                        <input type="button" id="applyTemplate" value="Apply Template" />										
										<input type="button" id="exportTemplate" value="Export Template[Text]" />
										a class="button" id="exportTemplate">Export Template[Text]</a> |	
										<a class="button" id="clearTemplate">Clear Template</a-->		
									</div>														
								</div>
									...
									<?php
										...
										foreach($container as $show_container)
										{
											echo '<a class="button" id="addContainer_'.$show_container['containerid'].'">
													<img class="add-widget-container-img"  data-typeId='.$show_container['containerid'].' src="'.base_url().$show_container['container_imagepath'].'"/>
												  </a> ';
												  $i++;
										}
									?>                                   
...
<script type="text/javascript" src="<?php echo $template_design_js; ?>js/template-manager.js"></script>
	...
	$.ajax({					
			...
			success: function (data) {
				...
				else if(data == 2)
				{
					...
					$('#locked_by_info').html('Locked By &nbsp;&nbsp;: Vidyut Info');
					$('#locked_by_info').show();	
					*/
				}				
			},
...
function show_lock_info(lock_status, locked_user_name)
{
	...
	toastr.options = {
		...
		//var total_versions = '<?php echo $total_versions; ?>';		
		...
		//IExp.pageMaster.total_versions	=  "<?php //echo $total_versions; ?>";
...
<!-- popup code -->
<?php $frontend_css = base_url()."css/admin/";  ?>
...
<link type="text/css" rel="stylesheet" href="<?php echo base_url()."css/admin/"; ?>bootstrap-datetimepicker.css" />
<link href="<?php echo base_url()."css/admin/"; ?>bootstrap-colorpalette.css" rel="stylesheet" type="text/css" media="all"  />
<script src="<?php echo base_url(); ?>js/bootstrap-colorpalette.js" type="text/javascript"  charset="utf-8"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/bootstrap-datetimepicker.min.4.14.30.js"></script>

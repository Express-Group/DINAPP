										...
										<div class="qnsans">
											...
											<div class="ans">
												...
												<div class="WidthPercentage margin-top-5 FloatLeft"> 
													<img src="<?php if(isset($settings_result['sitelogo']) && $settings_result['sitelogo'] != "") { echo base_url().$settings_result['sitelogo']; } else '#'; ?>" style="height:100px; width:450px;" id="logo_img" name="logo_img" border="0" />
										...
										<div class="qnsans">
											...
											<div class="ans">
												...
												<div class="margin-left-10 FloatLeft"> 
													<img src="<?php if(isset($settings_result['favouriteicon']) && $settings_result['favouriteicon'] != "") { echo base_url().$settings_result['favouriteicon']; } else '#'; ?>" style="height:35px; width:35px;" id="favicon_img" name="favicon_img" border="0" />

...
/*function get_subsections(mainsectionConfigId)
{
	...
	$.ajax({			
		url: base_url + "dmcpan/section_widget_articles/get_instanceSubsectionConfig",
		type: 'post',
		async: false,
				...
				<form name="article_popup_form" id="article_popup_form" action="<?php echo base_url()."dmcpan/section_widget_articles/add_widget_article/saveTemporary"; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <select class="controls" name="search_bytype" id="search_bytype" >
					...
					?>                    
						...
						{ 
							if( $sec_values['categoryName'] == 'ஜோதிடம்' && $check_widget_type == 'jothida_manager' or ($sec_values['categoryName']!= 'புகைப்படங்கள்' && $sec_values['categoryName']!= 'வீடியோக்கள்' && $sec_values['categoryName']!= 'ஆடியோக்கள்' && $check_widget_type != 'jumbo_widget_articles' && $check_widget_type != 'jothida_manager' ) or $check_widget_type == 'jumbo_widget_articles' )
							{
...
<script src="<?php echo base_url()."js/section_widget_article_js.js" ?>" ></script> 
<script type="text/javascript">

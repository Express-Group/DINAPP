...
<link href="<?php echo base_url(); ?>includes/ckeditor/contents.css" rel="stylesheet" type="text/css" id="contents_css" />
...
<textarea class="ckeditor"  id="article_head_line_id" name="txtArticleHeadLine"><?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo $get_article_details['title']; ?></textarea>
            ...
            <input type="text" class="box-shad1 full-width" id="txtUrlTitle" name="txtUrlTitle"   value="<?php if(isset($get_article_details['url_title'])) echo htmlentities($get_article_details['url_title']); echo set_value('txtUrlTitle'); ?>" />
			 ...
			 <label>URL Structure : <a href="<?php  echo base_url().$get_article_details['url']."?page=preview"; ?>"><?php  echo base_url().$get_article_details['url']; ?></a></label>
			 <?php } ?>
				
            <label>Main Section<sup>*</sup></label>
            <div class="w2ui-field">

  <select name="ddMainSection" class="controls" id="main_section_id" section_data="<?php echo get_sectionname_by_id(get_parentid_by_sectionid(@$get_article_details['Section_id'])); ?>" Value="<?php echo set_value('ddMainSection'); ?><?php echo @$get_article_details['Section_id']; ?>">
...
<option id="MainSectionOption" style="color:#933;font-size:18px;"<?php /* if($mapping['Section_landing'] == 1 && $mapping['Sectionname'] != 'Columns' && $mapping['Sectionname'] != 'Magazine' && $mapping['Sectionname'] != 'The Sunday Standard' && $mapping['Sectionname'] != 'Editorials' ) { ?> disabled='disabled' <?php } */ ?>  class="blog_option" <?php if(set_value("ddMainSection") == $mapping['Section_id'] || (isset($get_article_details['content_id']) && $get_article_details['Section_id'] == $mapping['Section_id']  ) || ($page_name != 'edit_article' && $this->session->userdata('main_section') == $mapping['Section_id'] && folder_name == 'dmcpan')) { echo  "selected"; $section_bool=false; } ?> sectoin_data="<?php echo @$mapping['Sectionname']; ?>" rel="<?php echo @$mapping['LinkedToColumnist']; ?>"  value="<?php echo $mapping['Section_id']; ?>" url_structure="<?php echo mb_ucwords(str_replace("-"," ",str_replace("/"," > ",trim(GenerateBreadCrumbBySectionId($mapping['Section_id']))))); ?>" author_name="<?php echo (isset($mapping['AuthorID']) && $mapping['AuthorID'] != '')? get_authorname_by_id($mapping['AuthorID']) : '' ; ?>"><?php echo strip_tags($mapping['Sectionname']); ?></option>
  <?php if(!(empty($mapping['sub_section'])) ) { ?>
 
  <?php foreach($mapping['sub_section'] as $sub_mapping) { ?>
  
  <option  id="MainSectionOption" <?php if(set_value("ddMainSection") == $sub_mapping['Section_id']  || (isset($get_article_details['content_id']) && $get_article_details['Section_id'] == $sub_mapping['Section_id'] ) || ($page_name != 'edit_article' && $this->session->userdata('main_section') == $sub_mapping['Section_id'] && folder_name == 'dmcpan')) { echo  "selected";  $section_bool=false; } ?>  sectoin_data="<?php echo @$mapping['Sectionname']; ?>"  rel="<?php echo @$sub_mapping['LinkedToColumnist']; ?>" value="<?php echo $sub_mapping['Section_id']; ?>" url_structure="<?php echo mb_ucwords(str_replace("-"," ",str_replace("/"," > ",trim(GenerateBreadCrumbBySectionId($sub_mapping['Section_id']))))); ?>" author_name="<?php echo (isset($sub_mapping['AuthorID']) && $sub_mapping['AuthorID'] != '')? get_authorname_by_id($sub_mapping['AuthorID']) : '' ; ?>">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo strip_tags($sub_mapping['Sectionname']); ?></option>
		
		 <?php if(!(empty($sub_mapping['sub_sub_section']))) { ?>
		 
		   <?php foreach($sub_mapping['sub_sub_section'] as $sub_sub_mapping) { ?>
    <option id="MainSectionOption" <?php if($sub_sub_mapping['Section_landing'] == 1) { ?> disabled='disabled' <?php } ?>  <?php if(set_value("ddMainSection") == $sub_sub_mapping['Section_id']  || (isset($get_article_details['content_id']) && $get_article_details['Section_id'] == $sub_sub_mapping['Section_id'] ) || ($page_name != 'edit_article' && $this->session->userdata('main_section') == $sub_sub_mapping['Section_id'] && folder_name == 'dmcpan'))  { echo  "selected";  $section_bool=false; }  ?>  rel="<?php echo @$sub_sub_mapping['LinkedToColumnist']; ?>" value="<?php echo $sub_sub_mapping['Section_id']; ?>"  sectoin_data="<?php echo @$sub_mapping['Sectionname']; ?>" url_structure="<?php echo mb_ucwords(str_replace("-"," ",str_replace("/"," > ",trim(GenerateBreadCrumbBySectionId($sub_sub_mapping['Section_id']))))); ?>" author_name="<?php echo (isset($sub_sub_mapping['AuthorID']) && $sub_sub_mapping['AuthorID'] == '')? get_authorname_by_id($sub_sub_mapping['AuthorID']) : '' ; ?>" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo strip_tags($sub_sub_mapping['Sectionname']); ?></option>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery-ui.min.1.8.16.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/bootstrap/bootstrap.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/tags/angular.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/tags/bootstrap-tagsinput.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/tags/bootstrap-tagsinput-angular.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/tags/typeahead.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/article-pagination.js"></script>
...
<!-- Mansory & Infinite Scroll Script -->
 <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>css/admin/datepicker.min.css" />
<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery-1.11.3.min.js"></script>
...
<script type="text/javascript" src="<?php  echo base_url(); ?>includes/Tagedit-master/js/jquery-1.10.2.min.js"></script>
<!--<script type="text/javascript" src="<?php echo  base_url(); ?>includes/Tagedit-master/js/jquery-ui-1.9.2.custom.min.js"></script>
...
<script src="<?php echo base_url(); ?>js/jquery-ui.min-1.8.18.js" type="text/javascript"></script>

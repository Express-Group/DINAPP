...
<ul class="tabs margin-top-0 Article-Tab">
      ...
      <td><input type="text" class="box-shad" style="width:99.8% " id="txtUrlTitle" name="txtUrlTitle"  maxlength="255" value="<?php if(isset($get_audio_video_details['url_title']) && $get_audio_video_details['url_title'] != "") { echo $get_audio_video_details['url_title']; } echo set_value('txtUrlTitle'); ?>"  />
	   <?php echo form_error('txtUrlTitle'); ?>
	    <?php if(isset($get_audio_video_details['url'])) { ?>
			 <label>URL Structure : <a href="<?php  echo base_url().$get_audio_video_details['url']."?page=preview"; ?>"><?php  echo base_url().$get_audio_video_details['url']; ?></a></label>
		<?php } ?>
      </td>
     </tr>
 ...
 -->
  ...
  <select name="ddMainSection" class="controls" id="main_section_id" section_data="<?php echo get_sectionname_by_id(get_parentid_by_sectionid(@$get_audio_video_details['Section_id'])); ?>" Value="<?php echo set_value('ddMainSection'); ?><?php echo @$get_audio_video_details['Section_id']; ?>">
...
<script src="<?php echo base_url(); ?>js/jquery-1.10.2-autocomplete.js" type="text/javascript" ></script>
...
<script src="<?php echo base_url();?>js/audio_video.js"  type="text/javascript" ></script>

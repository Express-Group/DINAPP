...
<tr>
                      ...
                      <td> <input type="text" class="box-shad input_height WidthPercentage" name="txtUrlTitle" id="txtUrlTitle"  value="<?php if(isset($get_gallery_details['content_id'])) echo $get_gallery_details['url_title']; echo set_value('txtUrlTitle'); ?>"/>
						...
						<?php if(isset($get_gallery_details['url'])) { ?>
							<tr>
								...
								<td> <a href="<?php  echo base_url().$get_gallery_details['url']."?page=preview"; ?>"><?php  echo base_url().$get_gallery_details['url']; ?></a></td>
								</td>
							</tr>
                       <?php } ?>
  ...
  <select name="ddMainSection" class="controls" id="main_section_id" section_data="<?php echo get_sectionname_by_id(get_parentid_by_sectionid(@$get_gallery_details['Section_id'])); ?>" Value="<?php echo set_value('ddMainSection'); ?><?php echo @$get_gallery_details['Section_id']; ?>">
...
<?php } $Count++; } } ?>
 ...
 $("#gallery_data").val(JSON.stringify(SelectImage));
    ...
    <script src="<?php echo base_url(); ?>includes/ckeditor/ckeditor.js"  type="text/javascript"></script>
	...
	<script src="<?php echo base_url(); ?>js/gallery-process_js.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>js/FrontEnd/js/slick.js" type="text/javascript"></script>

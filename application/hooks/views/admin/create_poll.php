...
<script type="text/javascript" src="<?php echo base_url();?>js/poll_js.js"></script>
<script type="text/javascript"> var base_url = '<?php echo base_url(); ?>'; var folder_name = '<?php echo folder_name; ?>'; </script>
<link href="<?php echo base_url(); ?>css/admin/template_design/css/widget-articles.css" rel="stylesheet" type="text/css" />

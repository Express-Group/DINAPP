...
//if(strtolower($renderingType) != "3") {} 
?>
<div id="widgetConfigWindow">
  <h4> <?php echo $widgetName?> : Widget Configuration Window <!--<a href="javascript:parent.$.fancybox.close();" class="fa fa-times"></a>--></h4>
  <div class="form-container">
<?php //print_r($section_group['categoryList']); ?>
    <?php
	...
	//print_r($widget_instancesubsection); exit;
	...
	//print_r($instancesub_section); exit;
	?>
    <form id="widget_config_form">
	  ...
	  ?>
        ...
        <!--<li class="form-label">Widget Info:</li>
				<li> <?php //echo $widgetName?> <?php //echo $widgetStyle?></li>-->
        
        <?php 
					//echo $isSummaryAvailable;
		...
		//if($widget_instance_details['is_cloned'] == 1){ echo "checked"; }
		//$page_details 			= $this->template_design_model->getPageDetails($widget_instance_details['Pagesection_id'], $widget_instance_details['Page_type']);						
        ...
        <?php if(strtolower($renderingType) == "1" && FPM_ADDCONFIG) { ?>
                    ...
                    <li> 
                      <!--<input type="radio" name="renderingMode" id="renderingMode" value="manual" checked="checked" /> Manual <br />
                                    <input type="radio" name="renderingMode" id="renderingMode" value="auto" /> Auto -->
                      
                      <!-- <select name="renderingMode" id="renderingMode" onChange="if(this.value == 'auto'){$('#show_max_articles').val('');} else{$('#show_max_articles').val('');}"> -->
                    ...
                    <li class="max_articles">
                      <input type="text" name="show_max_articles" id="show_max_articles" value="" maxlength="2" />
                    </li>
...
$(document).ready(function() {
    ...
    //jq('#publish_end_date').data("DateTimePicker").minDate(e.date);
   /* $('#publish_starticon').click(function(){
        $('#publish_start_date').click();
    });
    ...
    function controll_sections_by_conten_id()
    {
		...
		//alert(controll_sections_by_content_type + ":" +typeof controll_sections_by_content_type);
...
/* $('#categorySelect').bind("change", function(){
	var section_category = $(this).find("option:selected").attr('section_type');
	section_category	 = (typeof section_category === "undefined" || section_category === "undefined") ? "0" : section_category;
	console.log(section_category);
	if(section_category != 0)
	{
		$('#categoryType option').attr("disabled", false);
		$('#categoryType option').each(function()
		{
			child_records = $(this).val();							
			if( child_records != section_category)
			{				
				//$(this).hide();
				$(this).attr("disabled", true); 

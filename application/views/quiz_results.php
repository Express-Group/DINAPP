...
$(document).ready(function(){
	$("#questions").steps({
		...
		onStepChanging: function (event, currentIndex, newIndex){
		 if(currentIndex > newIndex){ $('.wizard > .content').css('min-height','16em'); return true;}
...
<style>
		...
		sup{color:red;}
         .widget-container-188{margin-top:3%;}
		 .table th{background:#337ab7;color:#fff;}
		 .table td,.table th{text-align:center;}
		 .table td,.table th{font-size:12px;}
		 table {table-layout: fixed; word-wrap: break-word;}
		 .poll_results{font-weight:700;}
	</style>
 </head>
 <body>
...
<div class="container SectionContainer">-->
	<div class="row"><div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12  "><div class="widget-container widget-container-188"><div class="row">
...
</div></div></div><div class="row"><div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12  "></div></div><div class="row"><div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12  "></div>   <!--</div>
</section>--></div></div></div></div><div class="row"><div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12  "></div></div>    <!--</div>

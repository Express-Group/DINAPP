...
<html amp>
	<head>
		...
		<style amp-custom>
			...
			.article_heading{margin-top:5px;margin-bottom: 8px; color: #000;font-size: 23px;font-weight: normal;line-height: 1.3;}
	...
	<body>
		<div class="header">
			<a href="<?php print BASEURL; ?>"><amp-img src="<?php echo 'https://m.dinamani.com/assets/images/dinamani_logo.png'; ?>"  width="200"  height="51"  layout="responsive"  alt="Dinamani Logo"></amp-img></a>
		</div>
		<article class="article">
			...
			<?php
				...
				$article = str_replace(['<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">' ,'<html><body>' , '</body></html>','<?xml version="1.0" encoding="UTF-8"?>'] ,['','','',''] , $article);
			?>

...
if($this->uri->segment(1)=='topic')
{
	...
	$meta_title       = "Latest ".$tag_name." News, Photos, Latest News Headlines about ".$tag_name."- Dinamani";
	$meta_description = "Latest ".$tag_name." News and Updates, Special Reports, Videos and  Photos of ".$tag_name." on Dinamani. Articles on .".$tag_name.", Complete Coverage on ".$tag_name.".";
	$meta_keywords    = $tag_name.", ".$tag_name." Breaking News, ".$tag_name."Latest News,".$tag_name." Photos,".$tag_name." Videos, Articles on ".$tag_name;
}
...
if(in_array($country , $countryCode) && SHOWADS==true):
?>
<script type="text/javascript">

...
<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 brand-logo">
	...
	<div class="social_icons SocialCenter">
		<!--<span> 
			<a title="Dinamani Extension" class="android" href="https://chrome.google.com/webstore/detail/dinamani/bmfjebccakihjjjjogecichpabmjieak" rel="nofollow" target="_blank" style="padding-top: 4px;padding-bottom: 0;"><i class="fa fa-newspaper-o" aria-hidden="true" style="color: #f9905d;"></i></a> 
			<a class="android" href="https://play.google.com/store/apps/details?id=com.dinamani.news&hl=en" rel="nofollow" target="_blank"><i class="fa fa-android" aria-hidden="true"></i></a> 
			<a class="apple" href="https://itunes.apple.com/in/app/dinamani-tamil-news/id1244532821?mt=8" rel="nofollow" target="_blank" ><i class="fa fa-apple" aria-hidden="true"></i></a></span> -->
...
<div class=" col-lg-4 col-md-4 col-sm-6 col-xs-6">
	...
	<?php endif; 
	if($this->uri->segment(1)=='specialpage')
	{
	?>
	<div class="part-logo_mob">
	<style>
	.part-logo_mob img{width: 160px;}
	</style>
	<figure class="part-logo_mov"><img src="<?php echo static_url; ?>special_page/ucbrowser.png" /></figure>
	<?php
	}
	else
	{

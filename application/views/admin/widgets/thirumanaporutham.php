<link rel="stylesheet" href="<?php echo image_url; ?>css/FrontEnd/css/datepicker.css" type="text/css">
<script src="<?php echo image_url; ?>js/FrontEnd/js/bootstrap-datepicker.js" type="text/javascript"></script>
<style>
...
.porupu-thurapu{float: left;width: 100%;margin-bottom: 5px;color: #949292;font-size: 11px;text-align: justify;}
.margin-left-27{margin-left:27%;}
@media only screen and (max-width: 768px){
	.thirumanaporutham-50{width:100%;}
	.otp-input{width: 100%;margin: 0;}
	.label-padd{padding-top: 0;}
	.thirumanaporutham-success-list{width:100%;}
	.thirumanaporutham-success-list .success, .thirumanaporutham-success-list .failure{font-size:11px;}
	.tbl-second{font-size: 10px;}
}
</style>
<?php
...
<div class="thirumanaporutham-container">
	<div class="thirumanaporutham-inner-container">
		...
		<div class="thirumanaporutham-50">
			<p class="text-center margin-left-27">மணமகள்</p>
		...
		<div class="thirumanaporutham-50">
			<p class="text-center margin-left-27">மணமகன்</p>
			<div class="form-inputs">
				<label class="label-padd">பெயர்</label>
		...
		<div class="form-inputs text-center">
			<button style="width:auto;" class="porutham-btn">பொருத்தம் பார்க்க </button>
		</div>
		<div class="form-inputs margin-top-10">
			<span class="porupu-thurapu" style="color: #f39238;">பொறுப்புத் துறப்பு</span>
			<span class="porupu-thurapu">இந்தப் பொருத்தப்பட்டியல் மாதிரிக்காக கணினியினால் தயாரிக்கப்பட்டது. இது நீங்கள் கொடுக்கும் ராசி மற்றும் நட்சத்திரம் ஆகிய தகவல்களை மட்டுமே ஆதாரமாகக் கொண்டு தயாரிக்கப்பட்ட அடிப்படையான பொருத்தப்பட்டியல். இதைக் கொண்டு திருமணம் செய்ய விழைவோர் மேலதிக தகவல்களை ஒரு தேர்ந்த ஜோதிடரிடம் கொடுத்து இறுதி முடிவு செய்துகொள்ளுமாறு கேட்டுக்கொள்ளப்படுகிறார்கள்.</span>
		</div>
...
?>
	<div class="thirumanaporutham-inner-container" style="margin:0;padding:0;width: 100%;">
		<div class="thirumanaporutham-result-head">திருமணப் பொருத்தம் </div>
		 ...
		 <?php
			...
			if($getRasiUserDetails->num_rows()==1){
				...
				if($getRasiUserDetails[0]->otp_verified==1){
					...
					$manapenrasi1 = $rasipalan_sub_list[$getRasiUserDetails[0]->manapen_rasi.'_ta'][$manapenNachatiram];					
					$manamaganrasi1 = $rasipalan_sub_list[$getRasiUserDetails[0]->manamagan_rasi.'_ta'][$manamaganNachatiram];					
					...
					$template .='<tr><td>நட்சத்திரம் : '.$manapenrasi1.'</td><td>நட்சத்திரம் : '.$manamaganrasi1.'</td>';
					...
					if(__getstatus($GetRasiDetails[0]->dinam)=="2"){
						...
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($response=="உத்தமம்")?"success" : "failure").'"><span>தினப் பொருத்தம்ம்</span><span>'.$response.'</span></p></div>';
						$response='';
					}else{
					...
					if(__getstatus($GetRasiDetails[0]->stree_deergam)==2){
						...
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($response=="உத்தமம்")?"success" : "failure").'"><span>ஸ்த்ரீதீர்க்கப் பொருத்தம்</span><span>'.$response.'</span></p></div>';
						$response='';
					}else{
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($GetRasiDetails[0]->stree_deergam=="1")?"success" : "failure").'"><span>ஸ்த்ரீதீர்க்கப் பொருத்தம்</span><span>'.__getstatus($GetRasiDetails[0]->stree_deergam).'</span></p></div>';
					}
					if(__getstatus($GetRasiDetails[0]->yoni)=="2"){
						$response = __patham($GetRasiDetails[0]->yoni, $getRasiUserDetails[0]->manamagan_rasi, $getRasiUserDetails[0]->manamagan_nachatiram);
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($response=="உத்தமம்")?"success" : "failure").'"><span>யோனிப் பொருத்தம்</span><span>'.$response.'</span></p></div>';
						$response='';
					}else{
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($GetRasiDetails[0]->yoni=="1")?"success" : "failure").'"><span>யோனிப் பொருத்தம்</span><span>'.__getstatus($GetRasiDetails[0]->yoni).'</span></p></div>';
					}
					
					if(__getstatus($GetRasiDetails[0]->rasi)==2){
						$response = __patham($GetRasiDetails[0]->rasi, $getRasiUserDetails[0]->manamagan_rasi, $getRasiUserDetails[0]->manamagan_nachatiram);
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($response=="உத்தமம்")?"success" : "failure").'"><span>ராசிப் பொருத்தம்</span><span>'.$response.'</span></p></div>';
						$response='';
					}else{
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($GetRasiDetails[0]->rasi=="1")?"success" : "failure").'"><span>ராசிப் பொருத்தம்</span><span>'.__getstatus($GetRasiDetails[0]->rasi).'</span></p></div>';
					}
					...
					if(__getstatus($GetRasiDetails[0]->rasi_athipathi)==2){
						...
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($response=="உத்தமம்")?"success" : "failure").'"><span>ராசிஅதிபதிப் பொருத்தம்</span><span>'.$response.'</span></p></div>';
						$response='';
					}else{
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($GetRasiDetails[0]->rasi_athipathi=="1")?"success" : "failure").'"><span>ராசிஅதிபதிப் பொருத்தம்</span><span>'.__getstatus($GetRasiDetails[0]->rasi_athipathi).'</span></p></div>';
					}
					...
					if(__getstatus($GetRasiDetails[0]->rajju)==2){
						...
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($response=="உத்தமம்")?"success" : "failure").'"><span>ரஜ்ஜுப் பொருத்தம்</span><span>'.$response.'</span></p></div>';
						$response='';
					}else{
						$template .='<div class="thirumanaporutham-success-list"><p class="'.(($GetRasiDetails[0]->rajju=="1")?"success" : "failure").'"><span>ரஜ்ஜுப் பொருத்தம்</span><span>'.__getstatus($GetRasiDetails[0]->rajju).'</span></p></div>';
					}
					...
					$template .='<table class="table table-bordered tbl-second" style="margin-top:5%;float:left;">';
					...
					$template .='<tr class="text-center"><td class="thirumanaporutham-th">நட்சத்திரம்</td><td>'.$manapenrasi1.'</td><td>'.$manamaganrasi1.'</td><td></td></tr>';
					...
					$template .='<tr class="text-center"><td class="thirumanaporutham-th">ரஜ்ஜு</td><td>'.$manapenrasiDetails[0]->rajju.'</td><td>'.$manamaganrasiDetails[0]->rajju.'</td><td>'.$rajjuresponse.'</td></tr>';
					...
					$template .='</tbody>';
					$template .='</table>';
					$template .='<div class="form-inputs margin-top-10"><span class="porupu-thurapu" style="color: #f39238;">பொறுப்புத் துறப்பு</span><span class="porupu-thurapu">இந்தப் பொருத்தப்பட்டியல் மாதிரிக்காக கணினியினால் தயாரிக்கப்பட்டது. இது நீங்கள் கொடுக்கும் ராசி மற்றும் நட்சத்திரம் ஆகிய தகவல்களை மட்டுமே ஆதாரமாகக் கொண்டு தயாரிக்கப்பட்ட அடிப்படையான பொருத்தப்பட்டியல். இதைக் கொண்டு திருமணம் செய்ய விழைவோர் மேலதிக தகவல்களை ஒரு தேர்ந்த ஜோதிடரிடம் கொடுத்து இறுதி முடிவு செய்துகொள்ளுமாறு கேட்டுக்கொள்ளப்படுகிறார்கள்.</span></div>';
					echo $template;
				}else{
					redirect($sectionpath, 301);
				}

...
<li class="even">
 ...
 <?php if(isset($section_mapping)) { 
				$Except=array("ad_check","testing","Search","404","Newsletter","Privacy Policy","Terms of Use","rss","Advertise With Us","Contact Us","About Us","Careers","advertisement","testing menu","தேடல்");
				 foreach($section_mapping as $mapping) {  ?>
				 <?Php
					if(!in_array(strip_tags($mapping['Sectionname']),$Except)):
				?>

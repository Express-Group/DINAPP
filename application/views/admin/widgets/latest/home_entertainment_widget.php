...
.cinema-upper .cinema-upper-item{background: linear-gradient(to bottom,transparent 0,rgba(0,0,0,1) 80%);position: absolute;bottom: 0;padding: 21px 11px 12px;border-bottom-left-radius: 8px;border-bottom-right-radius: 8px;}

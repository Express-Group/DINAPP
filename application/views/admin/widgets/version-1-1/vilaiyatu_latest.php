...
if(count($widget_contents) > 0){
		...
		foreach($widget_contents as $get_content):
				...
				if($i==1){
					...
					$template .='<a href="'.$live_article_url.'"><img src="'.$dummy_image.'" data-src="'.$show_image_300.'" alt="'.$imagealt.'" class="img-responsive vilaiyatu_big_image"></a>';
					...
					$template .='<li class="vilayattu_thumb-story"><a href="'.$live_article_url.'"><img vilaiyatu-src="'.$dummy_image.'" data-src="'.$show_image_300.'" vilaiyatu-day="'.$day.'" vilaiyatu-month="'.$month.'" src="'.$dummy_image.'" data-src="'.$show_image_65.'" alt="" class="img-responsive vilayattu-thumb-img"></a><h4 class="vilayattu-thumb-title" vilaiyatu-src="'.$show_image_300.'" data-src="'.$show_image_300.'" vilaiyatu-day="'.$day.'" vilaiyatu-month="'.$month.'">'.$display_title.'</h4></li>';
				}
				if($i>1){
					$template .='<li class="vilayattu_thumb-story"><a href="'.$live_article_url.'"><img vilaiyatu-src="'.$show_image_300.'" data-src="'.$show_image_300.'" vilaiyatu-day="'.$day.'" vilaiyatu-month="'.$month.'" src="'.$show_image_65.'" alt="" class="img-responsive vilayattu-thumb-img"></a><h4 class="vilayattu-thumb-title" vilaiyatu-src="'.$dummy_image_390.'" data-src="'.$show_image_300.'" vilaiyatu-day="'.$day.'" vilaiyatu-month="'.$month.'">'.$display_title.'</h4></li>';
				}

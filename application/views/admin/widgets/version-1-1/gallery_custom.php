			...
			foreach($widget_contents as $get_content):
				...
				$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);
					if($i==1){
						...
						$template .='<div class="gallery_wrap_bigimage"><div class="gallery_wrap_thumbnails_thumbgallery_img gallery-img-hover"><div class="gallery_wrap_image_anim"><a href="'.$live_article_url.'"><img src="'.$dummy.'" data-src="'.$show_image_390.'" alt="'.$imagealt.'" /></a><i class="fa fa fa-camera gallery_camera-iconbig" aria-hidden="true"></i></div></div><h3 class="gallery_wrap_thumbnails_thumbgallery_leads">'.$display_title.'</h3></div>';
					}
					if($i==2){
					...
					if($i==10){
						$template .='<div class="gallery_wrap_bigimage gallery_wrap_thumbnails_thumbgallery_even"><div class="gallery_wrap_thumbnails_thumbgallery_img gallery-img-hover"><div class="gallery_wrap_image_anim"><a href="'.$live_article_url.'"><img src="'.$dummy.'" data-src="'.$show_image_390.'" alt="'.$imagealt.'" /></a><i class="fa fa fa-camera gallery_camera-iconbig" aria-hidden="true"></i></div></div><h3 class="gallery_wrap_thumbnails_thumbgallery_leads">'.$display_title.'</h3></div>';
						$template .='</div></div>';
					}
				$i++;
			endforeach;

...
if($content['RenderingMode'] == "manual"){
	...
	if(count($widget_contents) > 0){
		...
		foreach($widget_contents as $get_content):
				...
				if($i==5){
					 $template .='<div class="col-md-12 col-lg-12 col-sm-12 padding-off"><div class="col-md-6 col-lg-6 col-sm-12 padding-left-10"><a href="'.$live_article_url.'"><img src="'.$show_image_390.'" alt="'.$imagealt.'"  class="img-responsive" /></a><h4>'.$display_title.'</h4></div>';
				}
				if($i==6){

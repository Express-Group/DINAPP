...
if($original_image_path =="")                         // from cms || Live table    
{
	...
	$summary=(mb_strlen($summary) <=80)? $summary : mb_substr($summary,0,80,"utf-8")."...";// 80 = desired char count
																...
																if($showDate){
																	...
																	<article>
																	<a href="'.$live_article_url.'"><figure><img class="top_seithigal_image" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><span><i class="fa fa-clock-o" aria-hidden="true"></i> '.$dateTime.'</span></figure></a>
																	<figcaption class="lead-news-custom-widget">
																	<h4>'.$display_title.'</a></h4>';
																}else{
																	$show_simple_tab.='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-10">
																	<article>
																	<a href="'.$live_article_url.'"><figure><img class="top_seithigal_image" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></figure></a>
																	<figcaption class="lead-news-custom-widget">
																	<h4>'.$display_title.'</a></h4>';
																}

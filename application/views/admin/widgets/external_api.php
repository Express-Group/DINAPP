...
/*get site url */
	...
	elseif($render_mode=='dn'):
		...
		$api_url='http://www.dinamani.com/new-sitemap.xml';
	...
	?>
		<script>
			...
			function load_external_api_nie(widget_instance_id,widget_instance_id1,widget_title,external_url,template_type,widget_title_new){
				...
				if(render_mode=='dn'){
					var dummy_image='http://images.dinamani.com/uploads/user/imagelibrary/logo/dinamani_logo_150X150.jpg';
					var dummy_image1='http://images.dinamani.com/uploads/user/imagelibrary/logo/dinamani_logo_100X65.jpg';
				}else if(render_mode=='sm'){
			var dummy_image='http://images.samakalikamalayalam.com/uploads/user/imagelibrary/logo/nie_logo_150X150.jpg';
		var dummy_image1='http://images.samakalikamalayalam.com/uploads/user/imagelibrary/logo/nie_logo_100X65.jpg';

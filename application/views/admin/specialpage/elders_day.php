<html lang="en">
   <head>
      <title>Elders day Special | உலக முதியோர் தினம்  சிறப்புப் பக்கம் | தினமணி</title>
	...
	<div class="container">
		<div class="row" style="margin-bottom:5%;margin-top:3%;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<img src="<?php echo image_url; ?>special_page/elders_main.jpg" class="img-responsive img-thumbnail ls" style="width:100%;">
				<img src="<?php echo image_url; ?>special_page/elders_mobile.jpg" class="img-responsive img-thumbnail ms" style="width:100%;">
			</div>
		</div>
		<?php
		$i=1;

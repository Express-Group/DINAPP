<html lang="en">
   <head>
      <title>World Rose Day Special | புற்றை எதிர்கொண்டு வெற்றி |  உலக ரோஸ் நாள் சிறப்புப் பக்கம் | தினமணி</title>
...
@import url('https://fonts.googleapis.com/css?family=Pavanam');	
   ...
   /*  background-image: url('<?php echo image_url; ?>special_page/womensday-bg.jpg');
    background-repeat: no-repeat;
    background-size: 100%; */
   //background: url('<?php echo image_url; ?>special_page/water.jpg');
...
.hovereffect > a > .img-responsive {
  ...
  border-bottom: 5px solid #fe0606;
  width: 100%;
}
...
.uc-browser{width:9%;margin-top:4%;}
.banner-img {
...
.banner-img:nth-of-type(1){width:49%;margin-right:1%}
.banner-img:nth-of-type(2){width:49%;margin-left:1%}
footer{width:100%;}
footer a{color:#fff;}
  </style>
  <script>
...
<noscript>
  <img src="https://sb.scorecardresearch.com/p?c1=2&c2=16833363&cv=2.0&cj=1" />
   ...
   <body>
	<header class="header">
		<img src="https://www.dinamani.com/valentines-special/DIN-CRES-small.png" class="main-logo">
		<img class="pull-left group-logo" src="https://images.dinamani.com/images/FrontEnd/images/group.jpg">
		<!--<img class="pull-right uc-browser"  src="ucbrowser.png"> -->
		
		<div class="social_icons SocialCenter"> <a class="fb" href="https://www.facebook.com/DinamaniDaily" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a> <!--<a class="google" href="https://plus.google.com/116307064799770204456/" rel="nofollow" target="_blank"><i class="fa fa-google-plus"></i></a>--> <a class="twit" href="https://twitter.com/DinamaniDaily" rel="nofollow" target="_blank"><i class="fa fa-twitter"></i></a> 
		</div>
	...
	<div class="container">
		<div class="row" style="margin-bottom:5%;margin-top:3%;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<img src="<?php echo image_url; ?>special_page/Main-Banner.jpg" class="img-responsive img-thumbnail ls" style="width:100%;">
				<img src="<?php echo image_url; ?>special_page/rose_mobile.jpg" class="img-responsive img-thumbnail ms" style="width:100%;">
			</div>
		</div>
		<?php
		$i=1;
		foreach($articles as $article):
			...
			if(strlen($summary) > 75){
				$summary = mb_substr($summary , 0  ,72).'...';
			}
			...
			echo '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="hovereffect">
					<a href="'.$url.'"><img class="img-responsive" src="'.$show_image.'" alt=""></a>
					<div class="overlay" id="over">
					   <h2><a href="'.$url.'">'.$display_title.'</a></h2>
					   <p class="info">'.$summary.' </p>
					   <div><a href="'.$url.'" class="readmore"><i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
					</div>
				</div>
			</div>';
			if($i==3){
	  ...
	  <footer class="text-center">
		...
		<p> <a class="AllTopic" href="https://www.newindianexpress.com/" rel="nofollow" target="_blank">The New Indian Express | </a> <a class="AllTopic" href="https://www.kannadaprabha.com" rel="nofollow" target="_blank">Kannada Prabha | </a>  <a class="AllTopic" href="https://www.samakalikamalayalam.com/" rel="nofollow" target="_blank">Samakalika Malayalam | </a><a class="AllTopic" href="https://www.indulgexpress.com" rel="nofollow" target="_blank">Indulgexpress  | </a>  <a class="AllTopic" href="https://www.edexlive.com" rel="nofollow" target="_blank">Edex Live  | </a> <a class="AllTopic" href="https://www.cinemaexpress.com" rel="nofollow" target="_blank">Cinema Express | </a> <a class="AllTopic" href="https://www.eventxpress.com" rel="nofollow" target="_blank">Event Xpress  </a></p>

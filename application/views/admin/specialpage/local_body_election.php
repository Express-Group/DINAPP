...
<head>
  ...
  <style>
	...
	background: url('<?php echo image_url; ?>special_page/india-election.jpg');
	...
	.block-img{
		...
		position: relative;
		background: #fff;
		box-shadow: 0px 0px 10px 1px #ffffff57;
	...
	.header{
		padding: 5px;
		background: #fff;
		border-bottom: 4px solid #a91f1f;
		padding-bottom: 10px;
		text-align:center;
	}
	.header .col-md-1 img{
...
footer{width:100%;background:#fff;color:#000;font-size: 16px;margin-top: 2%;padding: 1%;border-top: 2px solid #a91f1f;}
...
<body id="imgs">
	...
	<!--<img src="https://images.dinamani.com/images/static_img/Main-Banner.jpg" class="img-responsive banner-img">-->
	<img src="<?php echo image_url; ?>special_page/election-banner3.jpg" class="img-responsive banner-img">
	<section>
		<div class="container">

...
@import url('https://fonts.googleapis.com/css?family=Pavanam');	
   ...
   background: url('<?php echo image_url; ?>images/static_img/epep_bg.jpg');
...
.hovereffect-2 > a > .img-responsive{
	width: 110px;
    float: left;
	margin-bottom:0;
}
...
.pagination a{margin: 0 7px 0;background: #ea4171;color: #fff;text-decoration: none;padding: 3px 10px 3px;border-radius: 5px;border:1px solid #ea4171;overflow:scroll;}
.pagination strong{margin: 0 7px 0;background: #fff;color: #ea4171;text-decoration: none;padding: 3px 10px 3px;border-radius: 5px;border:1px solid #ea4171;}
  </style>
  <script>
...
<noscript>
  <img src="https://sb.scorecardresearch.com/p?c1=2&c2=16833363&cv=2.0&cj=1" />
   ...
   <body>
	<header class="header">
		<a  href="https://www.dinamani.com"><img src="https://www.dinamani.com/valentines-special/DIN-CRES-small.png" class="main-logo"> </a>
	...
	<div class="container">
		<div class="row" style="margin-bottom:5%;margin-top:3%;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<img src="https://images.dinamani.com/images/static_img/epep1-section-banner.jpg" class="img-responsive img-thumbnail ls" style="width:100%;">
				<img src="https://images.dinamani.com/images/static_img/epep1-mobile-banner.jpg" class="img-responsive img-thumbnail ms" style="width:100%;">
			</div>
		</div>
		<?php
		$i=1;
		...
		foreach($articles as $article):
			...
			/* if($type==1){
				...
				echo '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="hovereffect hovereffect-2">
						<a href="'.$url.'"><img class="img-responsive" src="'.$show_image.'" alt=""></a>
						<div class="overlay" id="over">
						   <h2><a href="'.$url.'">'.$display_title.'</a></h2>
						</div>

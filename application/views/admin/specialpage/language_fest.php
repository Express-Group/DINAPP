...
<head>
  ...
  <style>
   ...
   background: url('<?php echo image_url; ?>special_page/bg-fest.jpg');
...
.uc-browser{width:9%;margin-top:3%;}
.banner-img {
...
.pagination a{margin: 0 7px 0;background: #ea4141;color: #fff;text-decoration: none;padding: 3px 10px 3px;border-radius: 5px;border:1px solid #ea4141;overflow:scroll;}
.pagination strong{margin: 0 7px 0;background: #fff;color: #ea4141;text-decoration: none;padding: 3px 10px 3px;border-radius: 5px;border:1px solid #ea4141;}
footer{width:100%;background:#fff;color:#000;font-size: 16px;margin-top: 2%;padding: 1%;border-top: 2px solid #ea4141;}
...
<body id="imgs">
	<header class="header">
		<a href="https://www.dinamani.com/" rel="nofollow" target="_blank"> <img src="<?php echo image_url; ?>special_page/DIN-CRES-small.png" class="main-logo"></a>
		...
		<div class="social_icons SocialCenter"> <a class="fb" href="http://www.facebook.com/DinamaniDaily" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a> <!--<a class="google" href="https://plus.google.com/116307064799770204456/" rel="nofollow" target="_blank"><i class="fa fa-google-plus"></i></a>--> <a class="twit" href="http://twitter.com/DinamaniDaily" rel="nofollow" target="_blank"><i class="fa fa-twitter"></i></a> 
		</div>
	...
	<section>
		...
		<div class="row" style="margin-bottom:5%;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<img src="<?php echo image_url; ?>special_page/din_fest-top-banner_new.png" class="img-responsive img-thumbnail banner-img">
			</div>
		</div>
		<?php
		$i=1;

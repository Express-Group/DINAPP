...
$amp_url	=	str_replace('.html','.amp',BASEURL. html_entity_decode($articles['url'],null,"UTF-8"));
$amp_url	=	str_replace('www.','m.',$amp_url);

?>
<url>
<loc><?php echo BASEURL. html_entity_decode($articles['url'],null,"UTF-8"); ?></loc>
<xhtml:link media="only screen and (max-width: 640px)" rel="amphtml" href="<?php echo $amp_url;?>"/>

...
$page_title = trim(strip_tags(html_entity_decode($article_landing_details[0]['title'],ENT_QUOTES,"UTF-8")));
$page_description = trim(strip_tags(html_entity_decode($article_landing_details[0]['summary_html'],ENT_QUOTES,"UTF-8")));
...
<?php
$title = trim(strip_tags(html_entity_decode($article_landing_details[0]['title'],ENT_QUOTES,"UTF-8")));
/* $title = strip_tags(str_replace(['&', '&#39;'], ['&amp;', "'"] , $title));
$title = preg_replace("|&([^;]+?)[\s<&]|","&amp;$1 ",$title); */
$summary = trim(strip_tags(html_entity_decode($article_landing_details[0]['summary_html'],ENT_QUOTES,"UTF-8")));
...
$fullimage = image_url.imagelibrary_image_path.'logo/dinamani_logo_600X300.jpg';
...
$mappedSections = $controller->mapped_section($contentType ,$article_landing_details[0]['content_id']);
?>
<item>
<Articleid><?php echo $article_id; ?></Articleid>
<title><![CDATA[<?php echo $title; ?>]]></title>
<excerpt><![CDATA[<?php echo $summary; ?>]]></excerpt>
<description><![CDATA[<?php echo $content; ?>]]></description>
<category><![CDATA[<?php echo $mappedSections; ?>]]></category>
...
<?php 
if($contentType==3): 
$galleryImages = $this->widget_model->get_content_by_id($article_landing_details[0]['content_id'], $contentType, "");

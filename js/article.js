...
$("#drop-area").on('dragenter', function (e){
	...
	function(physical_name, element, params) {
		...
		if(typeof $('#home_physical_name').val() != 'undefined' && $.trim($('#home_physical_name').val()) != '' && $.trim($('#home_image_gallery_id').attr('rel')) == ''  && physical_name == $.trim($('#home_physical_name').val())) {
			article_bool = false;
		}
